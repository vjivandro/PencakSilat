...
public class SejarahActivity extends AppCompatActivity implements OnPageChangeListener, OnLoadCompleteListener {

    private static final String TAG = SejarahActivity.class.getSimpleName();
    public static final String SAMPLE_FILE = "sejarah.pdf";
